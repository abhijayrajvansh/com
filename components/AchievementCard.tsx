...
const AchievementCard:React.FC<AchievementCardProps> = ({thumbnail, tilt, position, title}) => {
  return (
    <div className={`border ${thumbnail} bg-cover bg-center border-default-200 w-full my-5 sm:w-1/2 rounded-xl ${tilt === 'right' ? 'hover:rotate-1' : 'hover:-rotate-1'} transition`}>
