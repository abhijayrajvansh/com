      ...
      <div className="">
        ...
        <div className="">
          ...
          <p className="text-paragraph mt-3">
            ...
            as a freelance software engineer and technical consultant, I help
            turn ideas into fully functional digital products. I offer practical
          ...
          <p className="text-paragraph mt-3">
            ...
            developers about my unique approaches to solving problems through
            videos & writing{" "}
